...
//增加大理石配方
mods.techreborn.industrialGrinder.addRecipe(<techreborn:dust:32> *3 , <techreborn:smalldust:32> *2 , <techreborn:smalldust:3> * 2, null, <ore:stoneMarble>, null, <liquid:water>, 100, 512);